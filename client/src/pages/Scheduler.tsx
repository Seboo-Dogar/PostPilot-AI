      ...
      <div className="w-full lg:w-[460px] shrink-0">
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <form action="" className="space-y-5" onSubmit={handleSchedule}>
            {/* Plateform  */}
            <div className="">
              <label htmlFor="" className="block text-xs text-slate-500 uppercase mb-2">Platform</label>
            ...
            {/* Media Upload */}
            <div className="">
              <label className="block text-xs text-slate-500 uppercase mb-2">Media(0ptional)</label>
              {mediaFile ? (
                ...
                <label className="flex items-center justify-center gap-2 p-5 py-10 border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border-red-300 hover:bg-red-50/30 transition-all group">
                  ...
                  <input type="file" className="hidden" accept="image/*,vi transition-alldeo/*" onChange={(e) => e.target.files?.[0] && setMediaFile(e.target.files[0])} />
                </label>
              )}
            </div>
