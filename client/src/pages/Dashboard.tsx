        ...
        {activites.length === 0 ? (
          ...
          <div className='divide-y divide-slate-50'>
            {activites.map((activity) => (
              <div className='flex items-start gap-4 px-6 py-4 hover:bg-slate-50/50 transition-colors' key={activites._id}>
                ...
                <div className='flex-1 min-w-0'>
                  <div className='flex items-center justify-between gap-2 mb-1'>
                    <span className='text-xs px-2 py-0.2 rounded-full bg-zinc-100 text-zinc-600'>Published</span>
