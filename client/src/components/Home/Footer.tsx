        ...
        <footer style={{ background: "#fafafa", borderTop: "1px solid rgba(0,0,0,0.07)" }}>
            <div className="max-w-6xl mx-auto px-5 sm:px-8 py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        <Link to="/" onClick={() => scrollTo(0, 0)} className="inline-flex items-center gap-2 mb-5">
                            ...
                            <span className="font-medium font-serif text-xl text-gray-800">PostPilot</span>
                        </Link>
                        <p className="text-sm text-gray-500 leading-relaxed max-w-xs">The AI-powered social media platform by PostPilot that helps creators and teams grow faster with less effort.</p>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8" style={{ borderTop: "1px solid rgba(0,0,0,0.07)" }}>
                    <p className="text-xs text-gray-400">© {new Date().getFullYear()} PostPilot. All rights reserved.</p>
